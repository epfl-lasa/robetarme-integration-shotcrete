...
# https://github.com/sudo-bmitch/docker-base/blob/main/bin/fix-perms
# Copyright: Brandon Mitchell
# License: MIT

# This script makes the bind mount specified at `entrypointd.sh` at the
# container have the same permissions as the directory at the host.
